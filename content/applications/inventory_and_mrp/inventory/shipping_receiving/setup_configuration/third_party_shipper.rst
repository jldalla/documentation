...
.. note::
   ...
   *eCommerce*, and *Website* apps. To install, go :ref:`here <general/install>`.
...
.. note::
   ...
   app. To publish a delivery method on the website, click the desired delivery method, then click
   the :guilabel:`Unpublished` smart button. Doing so changes that smart button to read:
   :guilabel:`Published`.
